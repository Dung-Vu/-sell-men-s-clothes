      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
           ...
           <a type="button" class="btn btn-block btn-success" style="float:right;width: 150px; text-align: center;" href="addProduct.php">Thêm sản phẩm</a>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover" >
                  ...
                  <tbody>
                    ...
                    <tr>
                    <td><?php echo $i?></td>
                    <td><?php echo $rowAllProduct['maSanPham']?></td>
                    <td><?php echo $row_getNameCategory['tenDanhMuc']?></td>
                    <td><?php echo $rowAllProduct['tenSanPham']?></td>
                    <td><?php echo $rowAllProduct['moTa']?></td>
                    <td><?php echo $rowAllProduct['soLuong']?></td>
                    <td><?php echo $row_getNameLevel['tenTrangThai']?></td>
                    <td><?php echo $rowAllProduct['hinhAnh']?></td>
                    <td>
                        <a type="button" class="btn btn-primary" style="margin-bottom: 10px;" href="actionProduct.php?id=<?php echo $rowAllProduct['maSanPham']?>">
                          Sửa sản phẩm
                        </a>
                        <a type="button" class="btn btn-primary" style="margin-bottom: 10px;background-color: #DB0D0D; border-color: #DB0D0D;" href="../../function.php?idDelete=<?php echo $rowAllProduct['maSanPham']?>">
                          Xóa sản phẩm
                        </a>
