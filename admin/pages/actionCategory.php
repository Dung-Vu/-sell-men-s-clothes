            ...
            <div class="card">
              ...
              <form action="../../function.php?id=<?php echo $row_getCategory['maDanhMuc']?>" method="POST">
                  <div class="form-group" style="width:70%">
                    ...
                    <input type="text" name="tenDanhMuc" class="form-control"  value="<?php echo $row_getCategory['tenDanhMuc']?>" required>
                  </div>
                  <div class="form-group" style="width:70%">
                    <label >Mô tả</label>
                    <input type="text" name="moTa" class="form-control"  value="<?php echo $row_getCategory['moTa']?>" required>
